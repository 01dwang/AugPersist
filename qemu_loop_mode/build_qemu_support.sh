...
# will be written to ../afl-qemu-loop-trace.
#
...
cp -f "${CPU_TARGET}-linux-user/qemu-${CPU_TARGET}" "../../afl-qemu-loop-trace" || exit 1

cd ..
ls -l ../afl-qemu-loop-trace || exit 1

echo "[+] Successfully created '../afl-qemu-loop-trace'."
exit 0
